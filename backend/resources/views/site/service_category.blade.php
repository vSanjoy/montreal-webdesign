...
@section('content')
    ...
    @endif
        <div class="psabs-container">
            <div class="container">
                @if (isset($categoryDetails) && $categoryDetails->title != null)
                        ...
                        <div class="col-12 col-md-12 {{$divClass}} indu_bx">
                            ...
                            @endif
                                ...
                                <div class="industry_left_pannel_text">
                                    ...
                                    @endif
                                        <a href="{{ route('site.'.$language.'.service-details', $itemPost->slug) }}" class="theme-color"> @lang('custom.label_read_more')</a>
                                    </p>
                                    <small>@lang('custom.label_in') <a href="{{ route('site.'.$language.'.service-category', $categoryDetails->slug) }}" class="category-small">{!! $categoryDetails->title !!}</a></small>
                                </div>
                            </div>
                        </div>
                    @endforeach
