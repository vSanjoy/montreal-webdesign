                        ...
                        <div class="col-12 col-md-12 {{$divClass}} indu_bx">
                            ...
                            @endif
                                ...
                                <div class="industry_left_pannel_text">
                                    ...
                                    @endif
                                        <a href="{{ route('site.'.$language.'.industry-details', $itemPost->slug) }}" class="theme-color"> @lang('custom.label_read_more')</a>
                                    </p>
                                    <small>@lang('custom.label_in') <a href="{{ route('site.'.$language.'.industries') }}" class="category-small">{!! $categoryDetails->title !!}</a></small>
                                </div>
                            </div>
                        </div>
                    @endforeach
