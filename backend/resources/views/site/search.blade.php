        ...
        <div class="container">
            <div class="row">                
                <div class="col-lg-8 col-xl-9">
                    <h3 class="search_widget_title">@lang('custom.label_search_results_for'): {!! $searchFor !!}</h3>
                        ...
                        <div class="col-12 col-md-12 {{$divClass}} indu_bx">
                            ...
                            @endif
                                ...
                                <div class="industry_left_pannel_text">
                                    ...
                                    {{-- <small>@lang('custom.label_in') <a href="{{ route('site.'.$language.'.news') }}" class="category-small">{!! $categoryDetails->title !!}</a></small> --}}
                                </div>
                            </div>
                        </div>
                    @endforeach
