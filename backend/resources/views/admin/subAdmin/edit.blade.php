				...
				<div class="card-body">
					...
					{{ Form::open([
						...
						<div class="form-body mt-4-5">
							<div class="row">
								<div class="col-md-6">
									<div class="form-group">
										...
										{{ Form::text('first_name', $details->first_name, [
                                                                'id' => 'first_name',
                                                                'class' => 'form-control',
                                                                'placeholder' => '',
                                                                'required' => 'required' ]) }}
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										{{ Form::text('last_name', $details->last_name, [
                                                                'id' => 'last_name',
                                                                'class' => 'form-control',
                                                                'placeholder' => '',
                                                                'required' => 'required' ]) }}
							...
							<div class="row mt-1">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										{{ Form::text('phone_no', $details->phone_no, [
                                                                'id' => 'phone_no',
                                                                'class' => 'form-control',
                                                                'placeholder' => '',
                                                                'required' => 'required' ]) }}
							...
							@php
							$image = '';
							if ($details->profile_pic != null && file_exists(public_path('images/uploads/account/'.$details->profile_pic))) {
								$image = '<img src="'.asset("images/uploads/account/thumbs/".$details->profile_pic).'" />';
							}
							@endphp
							<div class="row mt-1">
								<div class="col-md-6">
								...
								<div class="col-md-6">
									<div class="form-group">
										...
										<div id="preview-crop-image" class="preview-image" style="height: {{ config('global.IMAGE_CONTAINER') }}px; padding: 49px 2px 20px 2px; position: relative;">
										@if ($image)
											<a data-fancybox="gallery" href="{{ asset('images/uploads/account/thumbs/'.$details->profile_pic) }}">
												{!!$image!!}
											</a>
											<span class="delete-preview-image delete-uploaded-cropped-image" data-microtip-position="top" role="tooltip" aria-label="{{ trans('custom_admin.label_delete') }}" data-primaryid="{{ $id }}" data-dbfield="profile_pic" data-routeprefix="{{ $pageRoute }}" data-img-container="{{ config('global.IMAGE_CONTAINER') }}"><i class="fa fa-trash"></i></span>
										@endif
										</div>
