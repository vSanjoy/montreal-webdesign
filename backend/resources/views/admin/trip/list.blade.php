						...
						<table id="list-table" class="table table-striped table-bordered no-wrap list-data custom-table custom-table-second-column">
							<thead>
								...
								@endif
									...
									<th class="firstColumn">@lang('custom_admin.label_menu_category')</th>
									<th>@lang('custom_admin.label_title') (@lang('custom_admin.lang_english'))</th>
									<th>@lang('custom_admin.label_amount')</th>
