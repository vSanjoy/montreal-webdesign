									...
									<div class="row mt-1">
										<div class="col-md-6">
											<div class="form-group">
												...
												{{ Form::text('list_page_title['.$langKey.']', $details->getTranslation('list_page_title', $langKey), [
							...
							<div class="row mt-1">
								...
								<div class="col-md-6">
									<div class="row">
										<div class="col-md-8">
											<div class="form-group">
												<label class="text-dark font-bold">@lang('custom_admin.label_service_image')</label>
										...
										<div class="col-md-4">
											...
											@if ($details->service_image != null)
												@if (file_exists(public_path('/images/uploads/'.$pageRoute.'/'.$details->service_image)))
													<div class="image-preview-holder" id="image_holder_service_image">
														<a data-fancybox="gallery" href="{{ asset('images/uploads/'.$pageRoute.'/'.$details->service_image) }}">
															<img class="image-preview-border" id="service_image_preview mt-2" src="{{ asset('images/uploads/'.$pageRoute.'/'.$details->service_image) }}" width="180" height="110" />
														</a>														
														{{-- <span class="delete-preview-image delete-uploaded-preview-image" data-primaryid="{{ $id }}" data-imageid="service_image_preview" data-dbfield="service_image" data-routeprefix="{{ $pageRoute }}"><i class="fa fa-trash"></i></span> --}}
													</div>
												@endif												
											@endif
											</div>
