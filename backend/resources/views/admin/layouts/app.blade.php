    ...
    <script type="text/javascript">
        $(function () {
            try {
                ...
                if ($('#description2_fr').length) {
                    CKEDITOR.replace('description2_fr', {
                        language : 'fr',
                        filebrowserUploadUrl: "{{route('admin.ckeditor-upload', ['_token' => csrf_token() ])}}",
                        filebrowserUploadMethod: 'form',
                        allowedContent: true
                ...
                if ($('#other_description_en').length) {
                    CKEDITOR.replace('other_description_en', {
                        filebrowserUploadUrl: "{{route('admin.ckeditor-upload', ['_token' => csrf_token() ])}}",
                        filebrowserUploadMethod: 'form',
                        allowedContent: true
                    });
                }
                if ($('#other_description_fr').length) {
                    CKEDITOR.replace('other_description_fr', {
                        language : 'fr',
                        filebrowserUploadUrl: "{{route('admin.ckeditor-upload', ['_token' => csrf_token() ])}}",
                        filebrowserUploadMethod: 'form',
                        allowedContent: true
