        ...
        try {
            if ($request->isMethod('POST')) {
                $validationCondition = array(
                    'page_name.en'  => 'required|unique:'.($this->model)->getTable().',page_name,NULL,id,deleted_at,NULL',
                    'page_name.fr'  => 'required',
                    'title.en'      => 'required',
                    'title.fr'      => 'required',
                ...
                $validationMessages = array(
                    'page_name.en.required'    => trans('custom_admin.error_page_name', ['langKey' => 'english']),
                    'page_name.fr.required'    => trans('custom_admin.error_page_name', ['langKey' => 'francias']),
                    'page_name.en.unique'      => trans('custom_admin.error_name_unique'),
                ...
                if ($validator->fails()) {
                    ...
                    $uploadedBannerImage= $uploadedFeaturedImage = '';
                    ...
                    $saveData['slug']               = generateUniqueSlug($this->model, trim($request->page_name['en'],' '));
                    foreach ($this->websiteLanguages as $langKey => $langVal) {
                        $saveData['page_name'][$langKey]                = $request->page_name[$langKey] ?? null;
                        ...
                        $saveData['other_description'][$langKey]        = $request->other_description[$langKey] ?? null;
                        $saveData['banner_title'][$langKey]             = $request->banner_title[$langKey] ?? null;
                        $saveData['banner_short_title'][$langKey]       = $request->banner_short_title[$langKey] ?? null;
                        $saveData['banner_short_description'][$langKey] = $request->banner_short_description[$langKey] ?? null;
                    }
    ...
    public function edit(Request $request, $id = null) {
        ...
        try
        {
            ...
            if ($request->isMethod('POST')) {
                ...
                $validationCondition = array(
                    'page_name.en'  => 'required|unique:'.($this->model)->getTable().',page_name,'.$id.',id,deleted_at,NULL',
                    'page_name.fr'  => 'required',
                    'title.en'      => 'required',
                    'title.fr'      => 'required',
                    'banner_image'  => 'mimes:'.config('global.IMAGE_FILE_TYPES').'|max:'.config('global.IMAGE_MAX_UPLOAD_SIZE'),
                ...
                if ($validator->fails()) {
                    ...
                    $unlinkBannerImageStatus    = $unlinkFeaturedImageStatus = false;
                    $uploadedBannerImage        = $uploadedFeaturedImage = '';
                    ...
                    $updateData['slug']                 = generateUniqueSlug($this->model, trim($request->page_name['en'],' '), $data['id']);
                    foreach ($this->websiteLanguages as $langKey => $langVal) {
                        $updateData['page_name'][$langKey]                = $request->page_name[$langKey] ?? null;
                        ...
                        $updateData['other_description'][$langKey]        = $request->other_description[$langKey] ?? null;
                        $updateData['banner_title'][$langKey]             = $request->banner_title[$langKey] ?? null;
                        $updateData['banner_short_title'][$langKey]       = $request->banner_short_title[$langKey] ?? null;
                        $updateData['banner_short_description'][$langKey] = $request->banner_short_description[$langKey] ?? null;
                    }
