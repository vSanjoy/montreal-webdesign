        ...
        try {
            ...
            if ($request->isMethod('POST')) {
                $validationCondition = array(
                    ...
                    'website_title.en'  => 'required',
                    'website_title.fr'  => 'required',
                ...
                $validationMessages = array(
                    ...
                    'website_title.en.required' => trans('custom_admin.error_website_title', ['langKey' => 'english']),
                    'website_title.fr.required' => trans('custom_admin.error_website_title', ['langKey' => 'francias']),
                ...
                if ($validator->fails()) {
                    ...
                    if ($websiteSettings == null) {
                        ...
                        $saveData['toll_free']          = $request->toll_free ?? null;

                        foreach ($this->websiteLanguages as $langKey => $langVal) {
                            $saveData['website_title'][$langKey]    = $request->website_title[$langKey] ?? null;
                            $saveData['address'][$langKey]          = $request->address[$langKey] ?? null;
                            $saveData['footer_address'][$langKey]   = $request->footer_address[$langKey] ?? null;
                            $saveData['copyright_text'][$langKey]   = $request->copyright_text[$langKey] ?? null;
                            $saveData['tag_line'][$langKey]         = $request->tag_line[$langKey] ?? null;
                        }
                        ...
                        $updateData['toll_free']          = $request->toll_free ?? null;

                        foreach ($this->websiteLanguages as $langKey => $langVal) {
                            $updateData['website_title'][$langKey]  = $request->website_title[$langKey] ?? null;
                            $updateData['address'][$langKey]        = $request->address[$langKey] ?? null;
                            $updateData['footer_address'][$langKey] = $request->footer_address[$langKey] ?? null;
                            $updateData['copyright_text'][$langKey] = $request->copyright_text[$langKey] ?? null;
                            $updateData['tag_line'][$langKey]       = $request->tag_line[$langKey] ?? null;
                        }
