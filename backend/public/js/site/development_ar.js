...
var successMessage              = 'نجاح';
var errorMessage                = 'خطاء';
var warningMessage              = 'تحذير';
var infoMessage                 = 'معلومات';
var btnSubmitting               = 'يتم الأرسال...';
var btnUpdating                 = 'يتم الرفع...';
var thankYouMessage             = 'شكراً لك';
var formSuccessMessage          = 'تم ارسال النموذج بنجاح . سيتم التواصل معك قريباً.';
var somethingWrongMessage       = 'حدث خطاء . قم بالمحاولة بوقت لاحق';
...
$(document).ready(function() {
    ...
    $("#contactForm").validate({
        ...
        messages: {
            ...
            email: {
                required: "اكتب بريدك الكتروني",
                valid_email: "اكتي بريدك الكتروني الصحيح",
            },
            subject: {
                required: "اكتب العنوان",
            },
            message: {
                required: "اكتب الرسالة",
            }
        },
        errorClass: 'error',
        errorElement: 'div',
    ...
    $("#careerForm").validate({
        ...
        messages: {
            first_name: {
                required: "اكتب الاسم الاول",
            },
            last_name: {
                required: "اكتب الكنية",
            },
            email: {
                required: "اكتب بريدك الكتروني",
                valid_email: "اكتي بريدك الكتروني الصحيح",
            ...
            phone: {
                required: "اكتب رقم الجوال",
            },
            subject: {
                required: "اكتب المسمى الوظيفي",
            },
            year_of_experience: {
                required: "اكتب عدد سنوات الخبره",
            },
            dob: {
                required: "اكتب تاريخ الميلاد",
            },
            why_you_want_to_work_with_us: {
                required: "اكتب لماذا تريد العمل معنا",
            },
            captcha: {
                required: "اكتب النتيجه",
            },
        },
        errorClass: 'error',
        errorElement: 'div',
