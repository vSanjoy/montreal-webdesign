...
$(document).ready(function() {
    ...
    $("#createCmsForm").validate({
        ...
        errorPlacement: function(error, element) {
            if ($(element).attr('id') == 'description_en' || $(element).attr('id') == 'description_fr') {
                error.insertAfter($(element).parents('div.form-group'));
            } else {
                error.insertAfter(element);
            }
    ...
    $("#createServiceForm").validate({
        ...
        messages: {
            ...
            'list_page_title[en]': {
                required: "Please enter list page title.",
            },
            'list_page_title[fr]': {
                required: "Please enter list page title.",
            },
            ...
            service_image: {
                required: "Please upload list page image.",
            },
        },
        errorClass: 'error invalid-feedback',
        errorElement: 'div',
...
// End :: Delete uploaded cropped image //
